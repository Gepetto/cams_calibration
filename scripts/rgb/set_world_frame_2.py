...
import cv2
import numpy as np
from utils.calib_utils import load_cam_params, save_pose_matrix_to_yaml, get_aruco_pose, get_relative_pose_world_in_cam2, list_cameras_with_v4l2
...
os.makedirs(os.path.join(config_path,"config","cam_params","images_world_cam_0","color"), exist_ok=True)
os.makedirs(os.path.join(config_path,"config","cam_params","images_world_cam_2","color"), exist_ok=True)
...
c1_color_imgs_dir = os.path.join(config_path,"config","cam_params", "images_world_cam_0", "color")
c2_color_imgs_dir = os.path.join(config_path,"config", "cam_params", "images_world_cam_2", "color")
# c3_color_imgs_dir = os.path.join(repo_path, "images_world_cam_3", "color")
c1_color_params_path = os.path.join(config_path,"config","cam_params","camera0_pose.yaml")
c2_color_params_path = os.path.join(config_path,"config","cam_params","camera2_pose.yaml")
...
K1, D1 = load_cam_params(os.path.join(config_path,"config","cam_params","c0_params_color.yaml"))
K2, D2 = load_cam_params(os.path.join(config_path,"config","cam_params","c2_params_color.yaml"))
...
cam_T1_world, cam_R1_world = get_relative_pose_world_in_cam2(os.path.join(c1_color_imgs_dir, "*.png"),K1,D1,detector, marker_size)
...
cam_T2_world, cam_R2_world = get_relative_pose_world_in_cam2(os.path.join(c2_color_imgs_dir, "*.png"),K2,D2,detector, marker_size)
