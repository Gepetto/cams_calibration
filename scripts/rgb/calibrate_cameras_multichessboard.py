...
import numpy as np
import cv2
from utils.calib_utils import calibrate_camera, calibrate_camera_multichessboard, save_cam_params, load_cam_params, stereo_calibrate, save_cam_to_cam_params, list_cameras_with_v4l2
...
try:
    while True:
        ...
        color_image_1 = frames[1]
        # color_image_2 = frames[2]
...
reproj1_color, mtx1_color, dist1_color = calibrate_camera_multichessboard(images_folder=os.path.join(c1_color_imgs_dir, "*.png"), checkerboard_configs=settings.checkerboard_configs)
