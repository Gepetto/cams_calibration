# To run the code from repo root : python3 -m cams_calibration.get_human_base_frame
...
os.makedirs(os.path.join(repo_path,"images_human_base_cam_1","color"), exist_ok=True)
os.makedirs(os.path.join(repo_path,"images_human_base_cam_2","color"), exist_ok=True)
os.makedirs(os.path.join(repo_path,"config","human_params"), exist_ok=True)

c1_color_imgs_dir = os.path.join(repo_path, "images_human_base_cam_1", "color")
c2_color_imgs_dir = os.path.join(repo_path, "images_human_base_cam_2", "color")

c1_color_params_path = os.path.join(repo_path,"config","human_params","c1_human_color.yaml")
c2_color_params_path = os.path.join(repo_path,"config","human_params","c2_human_color.yaml")
...
cam_T1_human, cam_R1_human = get_relative_pose_human_in_cam(os.path.join(c1_color_imgs_dir, "*.png"),K1,D1,detector, marker_size)
...
cam_T2_human, cam_R2_human = get_relative_pose_human_in_cam(os.path.join(c2_color_imgs_dir, "*.png"),K2,D2,detector, marker_size)
